    ...
    public class SpawnPointGizmo
    {
        ...
        static void DrawSpawnPointGizmo(SpawnPoint spawnPoint, GizmoType gizmoType)
        {
            ...
            if (spawnPoint.CheckForObstruction) {
                ...
                var overlapCount = Physics.OverlapBoxNonAlloc(boxPosition, extents, s_ObstructionColliders, spawnPoint.transform.rotation, spawnPoint.ObstructionLayers, QueryTriggerInteraction.Ignore);
                if (overlapCount != 0) {
