...
namespace Opsive.UltimateCharacterController.Character
{
    ...
    public abstract class CharacterLocomotion : StateBehavior, IForceObject
    {
        ...
        protected virtual void UpdatePosition()
        {
            ...
            m_MoveDirection += m_ExternalForce * deltaTime + (m_MotorThrottle * (UsingRootMotionPosition ? 1 : deltaTime) * m_TimeScale) - m_GravityDirection * m_GravityAmount * deltaTime;
